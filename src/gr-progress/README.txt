...
* Custom strings for time since last update (e.g. for quick and easy translating, or
  to change "2 days ago" to "2 floobargles since last update")
...
1. Make your Goodreads profile public (Account Settings - Settings - Who can view my profile: anyone),
   otherwise no books will be visible.
...
Create a new Goodreads user and get an API key for that user. Doesn't matter
